...
\begin{document}
  ...
  % \newpage
   ...
   % Kapitel einbinden
   \input{Kapitel/1_Einleitung/1_0_Einleitung}
   \input{Kapitel/Grundlagen/Grundlagen}
   \input{Kapitel/2_Stand_der_Technik/2_0_Stand_der_Technik}
   \input{Kapitel/3_Implementierung/3_0_Implementierung}
   \input{Kapitel/4_Ergebnisse/4_0_Ergebnisse}
   \input{Kapitel/5_Zusammenfassung/5_0_Zusammenfassung_und_Ausblick}
   \input{Kapitel/6_Anhang/6_0_Anhang}
  ...
  \printbibliography[heading=subbibliography, type=software, title={Internetquellen}]
