...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|c|c|c|c|c|c|c|}
			...
			\hline
			\textit{VGG-16} & DCGAN & MNIST & 2.000 & 0,11 sec & 4 min & \textbf{100,0\%}\\
			\hline
			\textit{VGG-16} & DCGAN & CelebA & 2.000 & 0,12 sec & 4 min & \textbf{100,0\%}\\
			\hline
		\end{tabular}
	}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|c|c|c|c|c|c|c|c|}
			\hline
			\textbf{Modell-Art} & \textbf{Verteidigungsart} & \textbf{Angriffsart} & \textbf{Datensatz} & \textbf{Iterationen} & \textbf{Dauer pro Iteration} & \textbf{Gesamtdauer} & \textbf{Genauigkeit}\\
			\hline
			\textit{VGG-16} & DP & KEDMI & MNIST & 2.000 & ? & ? & \textbf{13,0\%}\\
			\hline
			\textit{VGG-16} & DP & RBMI & MNIST & 40.000 & ? & ? & \textbf{98,44\%}\\
			\hline
		\end{tabular}
	}
